...
int main()
{
	...
	wstring strCppPath = strProjPath + L"Script\\CScriptMgr.cpp";
	wstring strHeaderPath = strProjPath + L"Script\\CScriptMgr.h";

	// 1. 현재 존재하는 모든 스크립트를 알아내야함.
	wstring strScriptIncludePath = CPathMgr::GetIncludePath();
	wstring strScriptCode = strScriptIncludePath + L"Script\\";
